"""LSTM baseline: two-layer LSTM over flattened full spatial frames, decoded to a full field.
...
EXPECTED_PARAMETERS = 3252610

class LSTMBaseline(nn.Module):
    def __init__(self):
        super().__init__()
        self.recurrent = nn.LSTM(2 * PATCH_SIZE * PATCH_SIZE, 256, num_layers=2, batch_first=True)
...
if __name__ == "__main__":
    ...
    print(f"trainable parameters: {count:,}  (Table 5: 3.253 M)")
